...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        event_start1=(TextView) findViewById(R.id.event2);
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //Date futureDate = dateFormat.parse("2020-07-26-22-07-00");
                    Date currentDate = new Date();
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    // Date nearFutureDate = dateFormat.parse("2020-07-26-22-07-00");
                    Date currentDate = new Date();
